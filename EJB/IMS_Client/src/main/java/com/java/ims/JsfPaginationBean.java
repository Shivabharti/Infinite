...
public class JsfPaginationBean {
	...
	public List<Insurance_Details> getInsurance_DetailsList() {
		if (cdList == null) {
			loadInsurance_Details();
		}
		return cdList;
	}
