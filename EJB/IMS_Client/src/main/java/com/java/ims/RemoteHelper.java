...
public class RemoteHelper {
	...
	public static CustomerBeanRemote lookupRemoteStatelessCustomer() throws NamingException {
		...
		final String beanName = "CustomerBean";
		...
		final String viewClassName = CustomerBeanRemote.class.getName();
		...
		return (CustomerBeanRemote) ctx.lookup("ejb:"
