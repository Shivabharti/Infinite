...
public class JsfPaginationBean {
	...
	private HmsDAOImpl queryHelper;
	/**
	 * pagination stuff
	 */
	...
	public List<Insurance_Claim> getInsClaimList() {
		if (cdList == null) {
			loadEmploy();
		}
		return cdList;
	...
	private void loadEmploy() {
		...
		cdList = queryHelper.getListOfInsClaim(firstRow, rowsPerPage);
