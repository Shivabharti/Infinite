...
public class CustomerDAOImpl implements CustomerDAO {
	...
	@Override
	public String addCustomer(Customer_Info customer) throws ClassNotFoundException, SQLException {
		String userId = customer.getUserName();
		Customer_Info customerFound = searchByUserName(userId);
	...
	@Override
	public Customer_Info searchByUserName(String userName) throws ClassNotFoundException, SQLException {
		connection = ConnectionHelper.getConnection();
